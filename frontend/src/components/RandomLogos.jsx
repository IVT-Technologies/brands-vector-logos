...
import { randomLogos } from "../apis/Alphabetical_Api";
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 mx-0.8 gap-6 md:gap-8 cursor-pointer">
            {logos.map((logo) => (
              ...
              >
                ...
                <button className="mt-2 sm:mt-3 px-4 sm:px-6 py-1 bg-indigo-100 text-indigo-700  sm:text-sm font-semibold rounded-full hover:bg-indigo-200 transition-colors">
                  View
                </button>
              </div>
            ))}
