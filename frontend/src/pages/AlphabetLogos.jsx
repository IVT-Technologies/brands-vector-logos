  ...
  return (
    <>
      <Helmet>
        <title>
          {searchQuery
            ? `Search results for "${searchQuery}" | Brands Vector Logos`
            : `Brand Logos Starting with "${alphabet.toUpperCase()}" | Brands Vector Logos`}
        </title>
        ...
        <meta
          ...
          content={
            searchQuery
              ? `Find vector logos for brands matching "${searchQuery}" in high-quality SVG format. Download free and use for your creative projects.`
              : `Browse and download free vector logos of brands starting with the letter "${alphabet.toUpperCase()}". Perfect for designers and marketers.`
          }
        />
        ...
        <link
          ...
          href={
            searchQuery
              ? `${BASE_URL}/alphabet?q=${encodeURIComponent(searchQuery)}`
              : `${BASE_URL}/alphabet/${alphabet.toLowerCase()}`
          }
        />
        ...
        <meta
          ...
          content={
            searchQuery
              ? `Explore vector logos for "${searchQuery}" and download them in SVG format for free.`
              : `Discover a wide selection of free SVG vector logos starting with "${alphabet.toUpperCase()}".`
          }
        />
      </Helmet>
